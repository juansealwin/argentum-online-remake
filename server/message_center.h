...
class MessageCenter {
 public:
  ...
  void notify_damage_received(const std::string &attacked, const unsigned int dmg,
  ...
  void notify_waiting_time_to_revive(const std::string &dst, unsigned int seconds);
  void notify_cant_attack_low_levels(const std::string &attacker, const std::string &attacked,
